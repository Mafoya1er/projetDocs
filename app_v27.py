...
def load_or_parse_data(file_path):
    ...
    if os.path.exists(data_file):
        ...
        Il présente aussi ses loisirs, ses centres d'intérêts et toutes les informations personnelles du candidat. Tu vas utiliser ce document pour répondre à toutes les questions qui te seront posées."""
        parser = LlamaParse(
